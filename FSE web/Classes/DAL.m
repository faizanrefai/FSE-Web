...
- (NSMutableArray *)SelectWithDistinctStar:(NSString *)strTableName withColumnName:(NSString *)strColumnname Condition:(NSString *)condition{
    NSMutableArray  *arryResult = [[NSMutableArray alloc] initWithCapacity:0];
    NSString *strSelect=@"SELECT ";
    //NSString *strStar=@" distinct ";
    NSString *strFrom=@" FROM ";
    NSMutableString *query=[[NSMutableString alloc]init];
	...
	if(condition)
    [query appendString:[NSString stringWithFormat:@"%@ ",condition]];
	
	[query appendString:strColumnname];
    [query appendString:strFrom];
    [query appendString:strTableName];
...
-(int)tableName:(NSString*)name
{
	NSString *strQuery = [NSString stringWithFormat:@"Delete from %@",name];
